  ...
  return <div id={'sponsors'} className={'text-center mt-5'}>
    <Container>
      ...
      <Row className={'justify-content-center'}>
        {!isLoading && sponsor && sponsor.diamond?.map(sponsor => (<Col xs={12} md={6} xl={3}>
      ...
      <Row className={'justify-content-center'}>
        {!isLoading && sponsor && sponsor.gold?.map(sponsor => (<Col xs={12} md={6} xl={3}>
          <div className="sponsor-card d-flex flex-column mt-5">
            <h5><a href={`/sponsors/${sponsor.id}`}>{sponsor.name}</a>
            </h5>
            <img src={sponsor.logo} alt={sponsor.name} />
      ...
      <Row className={'justify-content-center'}>
        {!isLoading && sponsor && sponsor.silver?.map(sponsor => (<Col xs={12} md={6} xl={3}>
          <div className="sponsor-card d-flex flex-column mt-5">
            <h5><a href={`/sponsors/${sponsor.id}`}>{sponsor.name}</a>
            </h5>
            <img src={sponsor.logo} alt={sponsor.name} />
      ...
      <Row className={'justify-content-center'}>
        {!isLoading && sponsor && sponsor.copper?.map(sponsor => (<Col xs={12} md={6} xl={3}>
          <div className="sponsor-card d-flex flex-column mt-5">
            <h5><a href={`/sponsors/${sponsor.id}`}>{sponsor.name}</a>
            </h5>
            <img src={sponsor.logo} alt={sponsor.name} />
      ...
      <Row className={'justify-content-center'}>
        {!isLoading && sponsor && sponsor.companion?.map(sponsor => (<Col xs={12} md={6} xl={3}>
          <div className="sponsor-card d-flex flex-column mt-5">
            <h5><a href={`/sponsors/${sponsor.id}`}>{sponsor.name}</a>
            </h5>
            <img src={sponsor.logo} alt={sponsor.name} />
